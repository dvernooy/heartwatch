 ...
 * @api
 */
#define ST2S(n) ((((n) - 1UL) / NIL_CFG_ST_FREQUENCY) + 1UL)
 ...
 * @api
 */
#define ST2MS(n) ((((n) - 1UL) / (NIL_CFG_ST_FREQUENCY / 1000UL)) + 1UL)
 ...
 * @api
 */
#define ST2US(n) ((((n) - 1UL) / (NIL_CFG_ST_FREQUENCY / 1000000UL)) + 1UL)
/** @} */
