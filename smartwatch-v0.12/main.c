...
9. [WAIT] faster write to SD card ... 512 byte buffer in code & remove 100 us delays in write chain
10.[WAIT] option for Fahrenheit
11.[WAIT] step counting algorithm
12.[WAIT] remove all the other printfs, add a way to do doubles with xprintf
13.[WAIT] data log the heartbeat
14.[WAIT] compass app
15.[WAIT] 
